...
write.csv(tract_comb,"c:/users/Andre/Downloads/yehupetz.csv")



read.csv("c:/users/Andre/Downloads/yehupetz.csv")
env_state
...
env_stat<-readOGR(dsn="c:/users/Andre/Downloads/env_stat.sqlite", layer="env_stat")


#this is the tract_comb origin, so where it is referenced, here is how it was created
tract_com<-as(env_stat, "sf")
